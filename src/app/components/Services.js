      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
          {services.map((service, index) => (
            ...
            >
              <div className="w-15 h-15 rounded-2xl  border-2 border-[var(--primary-color)] flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-300">
                {service.icon}
              </div>

              <h3 className="text-xl md:text-2xl font-medium group-hover:text-[#66e5ff] transition-colors duration-300">
                {service.name}
              </h3>
