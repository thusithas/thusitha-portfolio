...
function Hero() {
  return (
    <div id="home" className="py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center gap-8">
        ...
        <div className="flex-1 text-center lg:text-left">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="overflow-hidden shadow-[-20px_0px_50px_10px_rgba(0,200,255,0.8)] rounded-full w-[200px] h-[200px] mx-auto my-15 lg:m-10 bg-gradient-to-r from-[var(--primary-color)] to-[var(--primary-color)]"
          >
            <Image
              src="/images/Me3.png"
              alt="myphoto"
              width={180}
              height={180}
              className="mx-auto lg:mx-auto object-cover"
            />
          </motion.div>
          <motion.div
          ...
          >
            ...
            <motion.h1
              variants={animations.fadeInUp}
              className="text-3xl md:text-4xl text-[var(--primary-color)]"
            >
              <span className="bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] bg-clip-text text-transparent">
                A
              </span>{" "}
            ...
            <motion.p
              variants={animations.fadeInUp}
              className="text-[var(--text-color)] mt-4 text-sm md:text-base"
            >
            ...
            >
              ...
              <a
                href="/cv/Thusitha-Sampath-CV.pdf"
                download="Thusitha-Sampath-CV"
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex-1 flex justify-center lg:justify-end mt-15 md:mt-20 md:mb-10 lg:mt-0 lg:mb-0"
        >
          <div className="relative">
            {/* Floating Icons */}
            {/* Top Left - React */}
            <motion.div
              variants={animations.floatAnimation}
              initial="hidden"
              animate="animate"
              className="absolute -top-12 left-5 md:top-10 md:-left-20 lg:-top-10 lg:-left-5 animate-float"
            >
            ...
            {/* Top - WordPress */}
            <motion.div 
              variants={animations.floatAnimationDelayed}
              initial="hidden"
              animate="animate" className="absolute -top-12 left-70 transform -translate-x-1/2 md:top-10 md:left-130 lg:-top-20 lg:left-60 animate-float-delayed">
            ...
            <motion.div 
              variants={animations.floatAnimation}
              initial="hidden"
              animate="animate" className="absolute top-35 -left-3 transform -translate-y-1/2 md:top-70 md:-left-20 lg:top-42 lg:-left-25 animate-float">
            ...
            {/* Bottom Left - Laravel */}
             <motion.div 
              variants={animations.floatAnimationDelayed}
              initial="hidden"
              animate="animate" className="absolute top-30 left-73 md:top-60 md:left-125 lg:top-80 lg:-left-5 animate-float-delayed">
            ...
            <motion.div 
              variants={animations.floatAnimation}
              initial="hidden"
              animate="animate" className="absolute -bottom-15 left-1/2 transform -translate-x-1/2 md:-bottom-25 lg:-bottom-30 animate-float">
            ...
            <motion.div 
              variants={animations.scaleUp}
              initial="hidden"
              animate="visible" className="flex flex-col items-center">
